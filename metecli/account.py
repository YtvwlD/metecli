...
def setup_cmdline(global_subparsers):
    ...
    parser_buy.set_defaults(func=lambda args: Account().buy(args))
    ...
    parser_buy_barcode.set_defaults(func=lambda args: Account().buy_barcode(args))
    ...
    parser_pay.set_defaults(func=lambda args: Account().pay(args))
    ...
    parser_deposit.set_defaults(func=lambda args: Account().deposit(args))
    parser_logs = subparsers.add_parser("logs", help="display the logs")
    parser_logs.set_defaults(func=lambda args: Account().logs(args))
